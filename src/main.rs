...
use core::scene::{setup,run_animations,track_camera};
// use core::state::{State, Config};

mod structs;
use structs::base::{BaseDirection,BaseAnimation};
use structs::sprites::{PlayerSprite};
use structs::scene::{SceneCamera, PanOrbitConfig};
        ...
        match ev.state {
            ButtonState::Pressed => {
                ...
                match ev.key_code { // key binding
                    KeyCode::ArrowUp | KeyCode::KeyZ | KeyCode::KeyW => { sprite.direction = BaseDirection::Up },
                    KeyCode::ArrowDown | KeyCode::KeyS => { sprite.direction = BaseDirection::Down },
                    KeyCode::ArrowLeft | KeyCode::KeyQ | KeyCode::KeyA => { sprite.direction = BaseDirection::Left },
    ...
    for ev in evr_kbd.read() { // each active keyboard input event
        match ev.state {
            ButtonState::Pressed => {
                ...
                match ev.key_code { // key binding
                    KeyCode::ArrowUp | KeyCode::KeyZ | KeyCode::KeyW => { camera.direction = BaseDirection::Up },
                    KeyCode::ArrowDown | KeyCode::KeyS => { camera.direction = BaseDirection::Down },
                    KeyCode::ArrowLeft | KeyCode::KeyQ | KeyCode::KeyA => { camera.direction = BaseDirection::Left },
